...
$appName = "LinkAndSync" # ? Replace with your application project name.
$projDir = "I:\git\LinkAndSync\LinkAndSync" # ? Replace with your project directory (where .csproj resides).
